...
namespace ChristmasWithTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            xmas.Presents =  new string[3]{"Xbox", "Nintendo", "PlayStation" }; 
            ...
            if (xmas.List == true){
                Console.WriteLine("I was on the nice list so I get presents.");
            }else{
                Console.WriteLine("I am getting coal for Christmas.");
            }
